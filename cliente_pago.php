    ...
    <div class="container">
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    if($c){
                    $procedimiento = 'DECLARE BEGIN trabajo.OBTENER_PAGO_MULTA(:id,:multa); END;';
                        $stmt = oci_parse($c,$procedimiento);
                        oci_bind_by_name($stmt,':id',$id);
                        oci_bind_by_name($stmt,':multa', $multa,-1,OCI_B_INT);
                        oci_execute($stmt);                    
                    echo'
                   <div class="form-row">
                        <div class="col-md-12">
                        <div class="form-control total btn btn-info disabled" style="background-color: #041673;">Total: &nbsp; &nbsp;  <span class="amount">$'.$multa.'</span>  &nbsp;<i class="fas fa-coins"></i>';
                    }   
                    ?>
                        </div>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                            <button type="submit"  class="btn btn-warning btn-block" value="PAGAR" onclick="location.href='cliente_boleta.php'">PAGAR &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-lock"></i></button>
                        </div>
                    </div><!-- row -->
                    </div><!-- card-->
                </div> <!-- col -->
